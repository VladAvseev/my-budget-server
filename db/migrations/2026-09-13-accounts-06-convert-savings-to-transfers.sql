...
-- Шаг 6. Превращаем savings/savings_out в переводы между аккаунтами.
--
--   savings     : основной счёт -> аккаунт, соответствующий категории накоплений
--   savings_out : аккаунт, соответствующий категории накоплений -> основной счёт
--
-- Дата, сумма и description остаются прежними. category_id у сконвертированных
-- переводов обнуляется, потому что операция теперь относится к движению между счетами.
begin;
