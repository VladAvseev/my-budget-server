...
операций, включая массовое удаление daily. Исключения: обезличивание удаляет
операции целиком; удаление категории/отчёта разрешает обнуление category_id/report_id
